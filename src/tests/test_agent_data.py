"""Tests for DataArchitectAgent."""
from __future__ import annotations
import json
import pytest
from unittest.mock import AsyncMock, MagicMock
from archon.agents.data_architect import DataArchitectAgent
...
def _mock_response():
    return json.dumps({
        "findings": [{
            "id": "DA-001", "title": "Test finding",
            "description": "Test desc", "severity": "MEDIUM",
            "domain": "data-architect", "file_path": None,
...
class TestDataArchitectAgent:
    def test_domain(self, mock_llm, mock_searcher):
        ...
        agent = DataArchitectAgent(mock_llm, [mock_searcher], RAGRetriever(store))
        assert agent.domain == "data-architect"
    ...
    async def test_run_returns_output(self, mock_llm, mock_searcher):
        ...
        assert output.domain == "data-architect"
